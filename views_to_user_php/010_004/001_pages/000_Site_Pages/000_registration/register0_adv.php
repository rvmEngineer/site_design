     ...
     <div class="container">
         ...
         <div class="row">
            ...
            <div class="col-md-8">
                   <h1>Register </h1>
                              <?php
                                    if(isset($_SESSION['ERROR_MESSAGE_TO_REGISTER_PAGE']))
                                    {
                              ?>   
                          <div class="alert alert-danger" role="alert">             
                              <ul>
                                         <?php
                                                foreach( $_SESSION['ERROR_MESSAGE_TO_REGISTER_PAGE'] as $name => $value)
                                                {
                                          ?> 
                               ...
                               <?php
                                        unset($_SESSION['ERROR_MESSAGE_TO_REGISTER_PAGE']);
                                    }
                                ?>
